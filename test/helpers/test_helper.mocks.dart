...
import 'package:ditonton/domain/entities/movie_category.dart' as _i16;
...
class MockDatabaseHelper extends _i1.Mock implements _i14.DatabaseHelper {
  ...
  @override
  _i6.Future<void> insertCacheMovies(
          List<_i13.MovieTable>? movies, _i16.MovieCategory? category) =>
      (super.noSuchMethod(
          Invocation.method(#insertCacheMovies, [movies, category]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i6.Future<void>);
  @override
  _i6.Future<int> clearCacheMovies(_i16.MovieCategory? category) =>
      (super.noSuchMethod(Invocation.method(#clearCacheMovies, [category]),
          returnValue: Future<int>.value(0)) as _i6.Future<int>);
  @override
  _i6.Future<List<Map<String, dynamic>>> getCachedMovies(
          _i16.MovieCategory? category) =>
      (super.noSuchMethod(Invocation.method(#getCachedMovies, [category]),
              returnValue: Future<List<Map<String, dynamic>>>.value(
                  <Map<String, dynamic>>[]))
          as _i6.Future<List<Map<String, dynamic>>>);
}
